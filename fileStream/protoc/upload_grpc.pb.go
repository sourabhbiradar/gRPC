...
func (x *streamUploadUploadClient) Send(m *UploadReqt) error {
...
func (x *streamUploadUploadServer) Recv() (*UploadReqt, error) {
	m := new(UploadReqt)
