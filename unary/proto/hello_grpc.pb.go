...
type ExampleClient interface {
	ServerReply(ctx context.Context, in *HelloReqt, opts ...grpc.CallOption) (*HelloResp, error)
}
...
func (c *exampleClient) ServerReply(ctx context.Context, in *HelloReqt, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
type ExampleServer interface {
	ServerReply(context.Context, *HelloReqt) (*HelloResp, error)
...
func (UnimplementedExampleServer) ServerReply(context.Context, *HelloReqt) (*HelloResp, error) {
...
func _Example_ServerReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).ServerReply(ctx, req.(*HelloReqt))
	}
